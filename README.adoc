...
metadata:
  ...
  annotations:
    ...
    # Rancher receives userDataFile as text, but the driver expects a file path.
    # This mapping writes the text to a file and passes its path to the driver.
...
rancher-machine create \
  --driver oxide \
  --oxide-ssh-public-key 529885a0-2919-463a-a588-ac48f100a165 \
